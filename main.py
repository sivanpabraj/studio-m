...
class MandaniStudioBot:
    ...
    def __init__(self):
        ...
        logger.info("🚀 ربات استودیو مندانی راه‌اندازی شد")
...
به ربات استودیو مندانی خوش آمدید 🎥✨

ما در استودیو مندانی آماده ارائه خدمات حرفه‌ای عکاسی و فیلمبرداری هستیم:
...
لطفاً گزینه مورد نظرتان را انتخاب کنید:
    ...
    async def help_command(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
        """دستور راهنما /help"""
        help_text = """
📖 **راهنمای استفاده از ربات استودیو مندانی**
...
🌟 استودیو مندانی - کیفیت در خدمت شما
        """
    ...
    async def button_callback(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
        ...
        # تماس با ادمین
            ...
            contact_text = """
📞 **راه‌های تماس با استودیو مندانی**
...
🌟 استودیو مندانی
    ...
    def run(self):
        ...
        logger.info("🚀 ربات استودیو مندانی شروع به کار کرد...")
